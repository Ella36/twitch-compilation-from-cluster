...
class TwitchSelectorRequests():
    ...
    def get_clips_from_creator(self, creator: Creator, args):
        ...
        requests = twitch_api.get_clips_request_by_streamer(self.twitch_oauth_header, creator.name, started_at, ended_at)
...
def find_creator_interval_urls_requests(args):
...
if __name__ == "__main__":
    args = argparser()
    find_creator_interval_urls_requests(args)