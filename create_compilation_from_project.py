...
if __name__ == '__main__':
    ...
    if is_prompt_confirm('Publish to DB!'):
        publish(args)
    upload_cmd = f"./youtubeuploader-bin/youtubeuploader -filename {args.wd}/{args.wd}.mp4 --metaJSON {args.wd}/meta.json -thumbnail {args.wd}/thumbnail_with_icon.jpg -oAuthPort 8082\n"
    print(upload_cmd)
