...
CLUSTERS  = Clusters([
    ...
    Cluster(
        'napopularcyan',
        'popular NA streamers cyan atlas',
        [ 
            Creator('AnneMunition'),
            Creator('Anthony_Kongphan'),
            Creator('AquaFPS'),
            Creator('BakeeZy'),
            Creator('CDNThe3rd'),
            Creator('DanucD'),
            Creator('DanucD'),
            Creator('Deadlyslob'),
            Creator('DonutOperator'),
            Creator('GeeksEh'),
            Creator('GeneralSam123'),
            Creator('GernaderJake'),
            Creator('Grimmmz'),
            Creator('HutchMF'),
            Creator('IronFists_tv'),
            Creator('JAYBAYBAY'),
            Creator('Klean'),
            Creator('LVNDMARK'),
            Creator('MzDunk'),
